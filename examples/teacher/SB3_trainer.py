...
def evaluate(model_dir):
    ...
    # model = RecurrentPPO.load(model_dir, device='cuda', env=env,
    ...
    #
    #     # 对于列表
    #     with open('../data_record/greedy_comparion_l/model_l_' + str(METADATA['lqr_l_p']) + '_' + str(i + 1) + '.csv',
    #               'w', newline='') as file:
...
if __name__ == "__main__":
    if args.choice == '0' or args.choice == '1':
        ...
        if args.choice == '0':
            ...
            args.action_space = env.action_shape
            learn(env, log_dir)
        if args.choice == '1':
        ...
        model_dir = args.resume_path_model
        evaluate(model_dir)
