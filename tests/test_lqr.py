...
env.draw_point([-5, 3, -2], color=[0,255,0], thickness=20, lifetime=0)
env.draw_line([-5, 3, -2], [0, 0, -5], color=[0,0,255], thickness=20, lifetime=0)
env.draw_line([5, 3, -5], [-5, 3, -2], color=[0,0,255], thickness=20, lifetime=0)
env.draw_line([5, -3, -8], [5, 3, -5], color=[0,0,255], thickness=20, lifetime=0)
